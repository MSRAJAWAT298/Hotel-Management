		<div class="d-none d-md-block">
			<div class=" bg-white d-flex text-dark font-weight-bold ">
				...
				<ul class="d-flex mr-5 ml-auto pl-2}">
					...
					<li class="nav-item">
						<a class="nav-link"	href="https://www.linkedin.com/in/msrajawat" title="linkedin">
							<i class="fa fa-linkedin" style="font-size: 20px;">
							</i>
						</a>
					</li>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top ">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				...
				<ul class="{{class_name}}">	
					...
					<li class="nav-item active">
						<a class="nav-link" title="Back to Main Page" href="#">
							PORTFOLIO
						</a>
					</li>
