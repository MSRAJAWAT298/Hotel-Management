...
{% block fullcontainer %} {% include 'slider.tpl' %} {% endblock %}
...
{#============= search by Rating ====================#}
                    <div class="form-group font-weight-bold">Search by Star Category
                      <div class="form-check">
                        {{ form.radio('rating','5','form-check-input','checkbox')}}
                        <label class="form-check-label" for="exampleCheck1">5-Star</label>
                      </div>
                      <div class="form-check">
                        {{ form.radio('rating','4','form-check-input','checkbox')}}
                        <label class="form-check-label" for="exampleCheck1">4-Star</label>
                      </div>
                      <div class="form-check">
                        {{ form.radio('rating','3','form-check-input','checkbox')}}
